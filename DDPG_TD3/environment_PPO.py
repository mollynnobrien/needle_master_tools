...
class Environment:
    ...
    def __init__(self, mode, action_dim, log_f, img_stack, filename=None, device=torch.device('cpu')):
...
class Needle:
    ...
    def move(self, action, needle_in_tissue, iteration, log_f):
        ...
        self.dw, self.dx, self.dy = self.action2motion(action, iteration, log_f)
