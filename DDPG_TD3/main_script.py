...
import os
import random
from environment_pygame import Environment
from environment_pygame import PID
...
if __name__ == "__main__":
    ...
    parser.add_argument('mode', default='state')  # choose to train from state or image or image cat state

    # setup
    args = parser.parse_args()
    
    if args.mode == 'state':
        from TD3_priorized import TD3
    ...
    action_dim = 2
    env = Environment(action_dim, log_f, args.filename)
    ...
    # replay_buffer = ReplayBuffer(args.max_size)
