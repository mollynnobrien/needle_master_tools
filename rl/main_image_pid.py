...
def run(args):
    ...
    if args.pid == False:
        ...
        from needlemaster.environment_move_pid import Environment, PID
    ...
    while total_timesteps < args.max_timesteps:
        ...
        if done:
            ...
            episode_num += 1
            ## run from PID or learnt policy
            if episode_num % args.pid_freq == 0:
                pid_on = True

            if pid_on == True and pid_counter < args.pid_interval:
                pid_counter += 1
            else:
                pid_on = False
                pid_counter = 0
...
if __name__ == "__main__":
    ...
    parser.add_argument("--pid", default=False, action="store_true",
        help='Using pid guidance')
    parser.add_argument("--pid_freq", default=200, type=int,
        help='How long training from PID')
    parser.add_argument("--pid_interval", default=10, type=int,
        help='How many episodes PID runs')
